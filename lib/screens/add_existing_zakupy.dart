...
import 'package:spizarnia_domowa_app/screens/add_new_zakup.dart';
...
class AddExistingZakup extends StatelessWidget{
  ...
  onUpdatePressed(int index) {
    ...
    ProduktZakupy zakup = new ProduktZakupy(
      ...
      kategoriaZakupy: produktController.produkty[index].kategorieZakupy,
      ilosc: int.parse(iloscController.text),
      objectIdProduktu : produktController.produkty[index].objectId,
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      showDialog(context: context, builder: (_) =>
                                          AlertDialog(
                                            title: Text('Ilość ' +  produktController.produkty[index].nazwaProduktu + ' do listy zakupów. (' +  produktController.produkty[index].miara + ')'),
                                            content: SpinBox(
                                              ...
                                              TextButton(
                                                  onPressed: () {
                                                    ...
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      SnackBar(
                                                        content: Text("Dodano "  +  produktController.produkty[index].nazwaProduktu + ": "  + iloscController.text + " " +  produktController.produkty[index].miara ),
